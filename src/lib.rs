...
#[derive(Debug)]
pub struct NextCyberProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextCyberProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextCyber processing");
    
    let mut processor = NextCyberProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextCyberProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextCyberProcessor::new(false);
